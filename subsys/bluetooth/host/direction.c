 ...
 *	  controller capabilities related with Constant Tone Extenstion.
 *
 * @param[out] switch_sample_rates      Optional switchin and sampling rates.
 * @param[out] num_ant                  Antennae number.
 * @param[out] max_switch_pattern_len   Maximum supported antennae switchin
 *                                      paterns length.
					...
					uint8_t num_ant_id, uint8_t *ant_id)
{
	...
	/* If AoD is not enabled, ant_ids are igored by controller:
